...
public interface ItripImageMapper {
	...
	public ItripImage getItripImageById(@Param(value = "id") String id)throws Exception;

	public List<ItripImage>	getItripImageListByMap(Map<String, Object> param)throws Exception;
	public List<ItripImageVO>getItripImageListByMap2(Map<String, Object> param)throws Exception;
