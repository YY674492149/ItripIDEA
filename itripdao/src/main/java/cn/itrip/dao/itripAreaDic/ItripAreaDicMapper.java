...
public interface ItripAreaDicMapper {
	...
	public List<ItripAreaDic>	getItripAreaDicListByType(@Param(value = "id") int id)throws Exception;

	public List<ItripAreaDicVO> getItripAreaDicById(@Param(value = "id") int id)throws Exception;
